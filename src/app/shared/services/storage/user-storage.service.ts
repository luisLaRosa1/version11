...
export class UserStorageService {
  private readonly _sessionUserKey = 'keyUSR.info_';
  private readonly _folioInfoKey = 'keyFOLIO.info_';
  private readonly _initialPathKey = 'keyInitialRoute.info_';

  private readonly _TEMPUserKey = 'keyUSR.temp_';
  private readonly _TEMPProjectKey = 'keyUSR.project_';
  ...
  init(loginResponse: ILoginResponseDto): void {
    ...
    this.setInitialPath(loginResponse.path);
    ...
    this.saveInfo(
      ...
      loginSingle.refreshToken,
      {
        ...
        subproceso:
          multipleData.proyectos && multipleData.proyectos[0].subproceso,
      },
      loginResponse.path
    );
  }
  ...
  setInitialPath(value: string): void {
    sessionStorage.setItem(this._initialPathKey, value);
  }

  getInitialPath(): string {
    return sessionStorage.getItem(this._initialPathKey) ?? '/busquedas';
  }
