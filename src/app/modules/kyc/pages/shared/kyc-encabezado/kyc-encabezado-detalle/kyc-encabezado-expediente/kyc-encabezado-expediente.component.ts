...
@Component({
  selector: 'app-kyc-encabezado-expediente',
  templateUrl: './kyc-encabezado-expediente.component.html',
  styleUrls: ['./kyc-encabezado-expediente.component.scss'],
})
export class KycEncabezadoExpedienteComponent implements OnInit {
