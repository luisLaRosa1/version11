...
@Component({
  selector: 'app-kyc-bandeja-suspendida',
  templateUrl: './kyc-bandeja-suspendida.component.html',
  styleUrls: ['./kyc-bandeja-suspendida.component.scss'],
})
export class KycBandejaSuspendidaComponent {
