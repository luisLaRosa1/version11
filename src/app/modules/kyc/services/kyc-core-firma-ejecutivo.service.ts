...
import { IKycFirmaEjecutivo } from '../pages/core/helpers/interfaces/kyc-core-firma-ejecutivo';

@Injectable({
  providedIn: 'root',
})
export class KycFirmaEjecutivoService {
  ...
  getByIdAndGetCatalogosToEdit(
    _id: string
  ): Observable<IResponse<IKycFirmaEjecutivo>> {
    return this.http.get<IResponse<IKycFirmaEjecutivo>>(
