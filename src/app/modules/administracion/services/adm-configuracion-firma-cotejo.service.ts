...
// import { IEjectivo, IFirmaCotejo } from "../pages/adm-configuracion-firma-cotejo/adm-configuracion-firma-cotejo-form/adm-configuracion-firma-cotejo-form.component";
...
export class AdmConfiguradorFirmaCotejoService {
  private API_ADMINISTRACION = '';

  // private API_ADMINISTRACION = environment.url_administracion;
  ...
  addEjecutivo(proyecto: string, data: IEjectivo) {
    ...
    formData.append('file', data.file!, nameFile);
